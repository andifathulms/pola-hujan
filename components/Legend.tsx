...
export function Legend({ manifest }: LegendProps) {
  return (
    <section aria-label="Keterangan" className="flex flex-col gap-3 border border-rule bg-stock p-4 text-sm">
      ...
      <p className="border-t border-rule pt-2 text-xs text-ink/70">{manifest.datasetStatus}</p>
    </section>
  );
}
